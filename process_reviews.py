...
from review_components.regionwise import extract_country_name,extract_star_rating
from review_components.getloveandhateinfo import get_love_and_hate_comment_keywords
from review_components.vote_counter import extract_vote_counts,getvotesinfo
...
if __name__=="__main__":
    ...
    weighted_keywords = df.apply(lambda row: get_love_and_hate_comment_keywords(row['attributes'], row['id']), axis=1)
